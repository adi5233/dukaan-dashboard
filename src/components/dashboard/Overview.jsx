export default function Overview() {
  return (
    <section className="w-full mx-auto">
      <article className="w-full h-9 justify-between flex items-center">
        <div className="font-medium text-xl h-7 text-[#1A181E]">Overview</div>
        <div className="w-36 border flex items-center bg-[#FFFFFF] rounded border-[#D9D9D9] h-9">
          <div className="w-30 text-[#4D4D4D] font-normal text-base ml-3.5 my-1.5 h-6">
            This Month
          </div>
          <div className="ml-2 w-4 h-4 my-2.5">
